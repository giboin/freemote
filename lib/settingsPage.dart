...
class _ParamState extends State<SettingsPage> {
  ...
  Future<void> _getButtonIsActive() async {
    ...
    setState(() {
      buttonIsActive = json.decode(prefs.getString('buttonIsActive')??"{'error':'true'}");
    });
  }
            ...
            body: ListView.separated(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return [ListTile(
                    ...
                    CheckboxListTile(
                      title: Text("Bouton d'information sur le pad"),
                      onChanged: (bool? value) {
                        setState(() {
                          infoButton=value!;
                        });
                    ...
                    CheckboxListTile(
                        title: Row(children:[
                          ...
                          IconButton(
                              onPressed: (){
                                showDialog(context: context, builder: (BuildContext context){
                                  return const AlertDialog(title: Text("désactiver des touches"),
                                      content:Text('En appuyant longuement sur une touche de la télécommande, vous pouvez la désactiver.\nEffectuez un deuxième appui long pour la réactiver, et cochez cette case pour verrouiller cette fonctionnalité'));
                                }
                                );
                              },
